          ...
          <div className="max-w-screen-2xl mx-auto w-full flex justify-between items-center">
            <div className="max-w-3xl relative z-10">
              <div className="inline-block bg-primary-container px-3 py-1 mb-10">
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-on-primary-container font-headline">SOLUCIONES DE INGENIERÍA INDUSTRIAL</span>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
            <div className="flex flex-col bg-surface-container-lowest p-8 border border-outline-variant/10 h-full justify-center">
              ...
              <p className="text-secondary text-sm leading-relaxed mb-8 font-sans max-w-lg">
                Sistemas de transportadores de rodillos a medida para manufactura de alto rendimiento. Nuestras arquitecturas basadas en PLC garantizan sincronización de ultra-baja latencia y control preciso del proceso.
              </p>
              ...
              <button
                ...
                className="bg-primary-container text-on-primary-container px-6 py-4 font-black uppercase tracking-tight text-xs flex items-center justify-between gap-8 hover:brightness-110 transition-all font-headline w-full min-h-[48px]"
              >
            ...
            <div className="relative group overflow-hidden aspect-square h-full max-h-[500px] w-full mx-auto md:ml-auto">
              ...
              <Image
                ...
                className="object-cover grayscale brightness-90 contrast-125 transition-transform duration-1000 group-hover:scale-105"
              />
              ...
              <div className="md:col-span-5 space-y-4">
                <div className="bg-black/40 backdrop-blur-md border border-white/10 p-6 group hover:bg-black/60 transition-all duration-300">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="text-white font-black uppercase text-xs tracking-widest font-headline group-hover:text-primary-container transition-colors">MONITOREO SCADA/HMI</h4>
                  </div>
                  <p className="text-white/80 text-[11px] leading-relaxed font-sans pl-4">Visualización y control en tiempo real de procesos industriales mediante paneles SCADA y HMI configurados a medida.</p>
                </div>
                <div className="bg-black/40 backdrop-blur-md border border-white/10 p-6 group hover:bg-black/60 transition-all duration-300">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-1 h-4 bg-primary-container shadow-[0_0_8px_rgba(118,185,0,0.4)]"></div>
                  ...
                  <p className="text-white/80 text-[11px] leading-relaxed font-sans pl-4">Análisis de datos de proceso para detección temprana de anomalías y soporte en decisiones de mantenimiento preventivo.</p>
                </div>
                <div className="bg-black/40 backdrop-blur-md border border-white/10 p-6 group hover:bg-black/60 transition-all duration-300">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-1 h-4 bg-primary-container shadow-[0_0_8px_rgba(118,185,0,0.4)]"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
            <div className="order-2 md:order-1 relative group aspect-square h-full max-h-[500px]">
              <Image
                ...
                fill
                sizes="(max-width: 768px) 100vw, 50vw"
                className="object-cover grayscale transition-transform duration-1000 group-hover:scale-105 shadow-2xl border border-outline-variant/20"
              />
              <div className="absolute top-0 right-0 p-6 font-mono text-[8px] text-black/20 uppercase tracking-[0.4em] font-bold z-10">NODE_B_SERIES_004.X</div>
            </div>
