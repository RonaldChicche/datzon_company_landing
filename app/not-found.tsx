    ...
    <div className="bg-inverse-surface min-h-[calc(100vh-4rem)] flex items-center justify-center text-on-surface py-20">
      <main className="text-center max-w-6xl px-6 relative z-10">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-white leading-none mb-8 font-headline">
          404 <br />
          <span className="text-primary-container">RUTA INEXISTENTE</span>
        </h1>
        
        <p className="text-white/70 max-w-2xl mx-auto font-sans text-lg mb-10 leading-relaxed">
          La ruta solicitada no existe en el sistema. Verifica el identificador o regresa al panel principal.
        </p>
        
        <div className="flex justify-center">
          <Link
            href="/"
            className="bg-primary-container text-on-primary-container font-black px-10 py-5 text-lg uppercase tracking-tight hover:bg-white hover:text-black transition-all font-headline"
          >
            VOLVER AL INICIO
          </Link>
        </div>
